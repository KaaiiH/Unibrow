...
{
	this->character = Character::unknow;
	this->name = name;
	this->size = size;
	this->who = name;
...
Player* Player::createPlayer(Character character)
{
	Image *playerImage = new Image(SPRITE_PATH + "character\\" +std::to_string(character)+".png", sf::Vector2u(150, 150), sf::Vector2f(100.0f, 100.0f));
	Image *playerImageMirror = new Image(SPRITE_PATH + "character\\" + std::to_string(character) + "mirror.png", sf::Vector2u(150, 150), sf::Vector2f(0.0f, 0.0f));
	...
	AnimationEffect *powerBall = new AnimationEffect(std::to_string(character) + "skill0.png", { 4,3 }, 0.1f);
	...
	AnimationEffect *powerBallMirror = new AnimationEffect(std::to_string(character) + "skill0mirror.png", { 4,3 }, 0.1f);
